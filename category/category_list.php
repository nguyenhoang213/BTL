    ...
    <div class="content">
        ...
        <form action="" method="get">
            ...
            <select name="search_category">
                <option value="c1.category_id"
                    <?php if (isset($search_category) && $search_category == "c1.category_id") echo 'selected'; ?>>Mã
                    danh
                    mục</option>
                <option value="c1.category_name"
                    <?php if (isset($search_category) && $search_category == "c1.category_name") echo 'selected'; ?>>Tên
                    danh mục</option>
                <option value="c2.category_name"
                    <?php if (isset($search_category) && $search_category == "c2.category_name") echo 'selected'; ?>>
                    Danh
                    mục cha</option>
            </select>
